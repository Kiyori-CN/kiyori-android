...
class ScreenshotManager(private val activity: Activity) {
    ...
    companion object {
        ...
        private const val FOLDER_NAME = "Kiyori"
    }
    ...
    private fun saveToGallery(sourceFile: File) {
        try {
            val displayName = "Kiyori_${FormatUtils.generateTimestamp()}.png"
            ...
            if (imageUri != null) {
                ...
                // 删除临时文件
                sourceFile.delete()
                com.android.kiyori.utils.Logger.d(TAG, "Screenshot saved: $displayName")
            } else {
