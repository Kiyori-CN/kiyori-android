...
import com.android.kiyori.danmaku.DanmakuConfig
...
class PlayerDialogManager(
    ...
    private val composeOverlayManager: com.android.kiyori.manager.compose.ComposeOverlayManager,
    ...
    fun showPopupDialog(
        ...
        // 根据布局类型分别解析视图，避免引用仅存在于固定高度布局中的 ID。
        val dialogView: View
        val recyclerView: RecyclerView
        val scrollHint: TextView?
        val nestedScrollView: androidx.core.widget.NestedScrollView?

        if (useFixedHeight) {
            dialogView = activity.layoutInflater.inflate(R.layout.dialog_popup_menu_fixed, null)
            recyclerView = dialogView.findViewById(R.id.recyclerViewPopup)
            scrollHint = dialogView.findViewById(R.id.scrollHint)
            nestedScrollView = dialogView.findViewById(R.id.nestedScrollViewPopup)
        } else {
            dialogView = activity.layoutInflater.inflate(R.layout.dialog_popup_menu, null)
            recyclerView = dialogView.findViewById(R.id.recyclerViewPopup)
            scrollHint = null
        ...
        showPopupDialog(
            ...
            when (position) {
                ...
                1 -> {
                    ...
                    com.android.kiyori.danmaku.DanmakuConfig.setEnabled(false)
    ...
    fun showDanmakuSettingsDialog() {
        ...
        val currentSize = com.android.kiyori.danmaku.DanmakuConfig.size
        val currentSpeed = com.android.kiyori.danmaku.DanmakuConfig.speed
        val currentAlpha = com.android.kiyori.danmaku.DanmakuConfig.alpha
        val currentStroke = com.android.kiyori.danmaku.DanmakuConfig.stroke
        val currentShowScroll = com.android.kiyori.danmaku.DanmakuConfig.showScrollDanmaku
        val currentShowTop = com.android.kiyori.danmaku.DanmakuConfig.showTopDanmaku
        val currentShowBottom = com.android.kiyori.danmaku.DanmakuConfig.showBottomDanmaku
        val currentMaxScrollLine = com.android.kiyori.danmaku.DanmakuConfig.maxScrollLine
        val currentMaxTopLine = com.android.kiyori.danmaku.DanmakuConfig.maxTopLine
        val currentMaxBottomLine = com.android.kiyori.danmaku.DanmakuConfig.maxBottomLine
        val currentMaxScreenNum = com.android.kiyori.danmaku.DanmakuConfig.maxScreenNum
        ...
        composeOverlayManager.showDanmakuSettingsDrawer(
            ...
            onSizeChange = { size ->
                com.android.kiyori.danmaku.DanmakuConfig.setSize(size)
                danmakuManager.updateSize()
            },
            onSpeedChange = { speed ->
                com.android.kiyori.danmaku.DanmakuConfig.setSpeed(speed)
                danmakuManager.updateSpeed()
            },
            onAlphaChange = { alpha ->
                com.android.kiyori.danmaku.DanmakuConfig.setAlpha(alpha)
                danmakuManager.updateAlpha()
            },
            onStrokeChange = { stroke ->
                com.android.kiyori.danmaku.DanmakuConfig.setStroke(stroke)
                danmakuManager.updateStroke()
            },
            onShowScrollChange = { show ->
                com.android.kiyori.danmaku.DanmakuConfig.setShowScrollDanmaku(show)
                danmakuManager.updateScrollDanmaku()
            },
            onShowTopChange = { show ->
                com.android.kiyori.danmaku.DanmakuConfig.setShowTopDanmaku(show)
                danmakuManager.updateTopDanmaku()
            },
            onShowBottomChange = { show ->
                com.android.kiyori.danmaku.DanmakuConfig.setShowBottomDanmaku(show)
                danmakuManager.updateBottomDanmaku()
            },
            onMaxScrollLineChange = { line ->
                com.android.kiyori.danmaku.DanmakuConfig.setMaxScrollLine(line)
                danmakuManager.updateMaxLine()
            },
            onMaxTopLineChange = { line ->
                com.android.kiyori.danmaku.DanmakuConfig.setMaxTopLine(line)
                danmakuManager.updateMaxLine()
            },
            onMaxBottomLineChange = { line ->
                com.android.kiyori.danmaku.DanmakuConfig.setMaxBottomLine(line)
                danmakuManager.updateMaxLine()
            },
            onMaxScreenNumChange = { num ->
                com.android.kiyori.danmaku.DanmakuConfig.setMaxScreenNum(num)
