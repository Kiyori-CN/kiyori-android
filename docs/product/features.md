...
本文档用于说明 Kiyori 当前的浏览器能力、媒体能力和扩展模块。项目定位以浏览器为主入口，媒体播放与下载能力作为配套模块保留。
...
**技术文档：**
- [登录实现说明](../integrations/bilibili/login.md)
- [番剧解析原理](../integrations/bilibili/bangumi.md)
...
**技术文档：**
- [下载实现原理](../integrations/bilibili/download-principle.md)
...
**技术文档：**
- [弹幕下载原理说明](../integrations/bilibili/danmaku-download.md)
